...
public class NotesDB extends SQLiteOpenHelper {
	...
	public static final String COLUMN_NAME_COMPLETE_TIME = "complete_time";
	public static final String COLUMN_NAME_IS_COMPLETED = "is_completed";//任务是否完成 1 完成 0 未完成
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + TABLE_NAME_NOTES + "(" + COLUMN_NAME_ID
				...
				+ " TEXT NOT NULL DEFAULT \"\"," + COLUMN_NAME_COMPLETE_TIME
				+ " TEXT NOT NULL DEFAULT \"\"," + COLUMN_NAME_IS_COMPLETED
